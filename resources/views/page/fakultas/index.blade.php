    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="font-weight-bold mb-0 ml-5">Data Fakultas</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datafakultas" class="table table-striped table-sm display nowrap" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Kode Fakultas</th>
    ...
    <script>
        function removedata(id) {
            Swal.fire({
                ...
                text: "Yakin menghapus data fakultas ini ?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ url('fakultas/deleteData') }}" + '/' + id,
                        dataType: "json",
                        beforeSend: function() {
                            $('#deleteIcon_' + id).hide();
        ...
        $(document).ready(function() {
            ...
            $('#datafakultas').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                ajax: "{{ url('fakultas/index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
